import { SignInButton, SignedIn as HeadloSignedIn, SignedOut as HeadloSignedOut } from 'headlo-auth'
import { SignInButton as ClerkSignInButton, SignedIn as ClerkSignedIn, SignedOut as ClerkSignedOut } from '@clerk/clerk-react'
    ...
    <div style={s.page}>
      ...
      <main style={s.main}>
        <div style={s.card}>
          ...
          <div style={s.ctaRow}>
            <HeadloSignedOut>
              <SignInButton forceRedirectUrl="/dashboard">
                <button style={s.cta as React.CSSProperties}>
                  Sign in with Headlo →
                </button>
              </SignInButton>
            </HeadloSignedOut>
            <HeadloSignedIn>
              ...
              >
                Already signed in to Headlo — Continue →
              </a>
            </HeadloSignedIn>
          </div>
          ...
          <div style={s.ctaRow}>
            <ClerkSignedOut>
              <ClerkSignInButton mode="modal" forceRedirectUrl="/clerk/dashboard">
                <button style={s.ctaSecondary as React.CSSProperties}>
                  Sign in with Headlo Clerk →
                </button>
              </ClerkSignInButton>
            </ClerkSignedOut>
            <ClerkSignedIn>
              <a
                ...
                style={{
                  ...(s.ctaSecondary as React.CSSProperties),
                  display:        'block',
                  textAlign:      'center' as const,
                  textDecoration: 'none',
                  boxSizing:      'border-box',
              ...
              >
                Already signed in to Clerk — Continue →
              </a>
            </ClerkSignedIn>
          </div>
