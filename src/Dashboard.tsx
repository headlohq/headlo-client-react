    ...
    <div style={s.page}>
      ...
      <main style={s.main}>
        ...
        <section style={s.linkSection}>
          ...
          <a href="/multiauth/dashboard" style={s.linkCard}>
            <div style={s.linkCardTitle}>→ Multi-auth dashboard</div>
            <div style={s.linkCardBody}>
              Migration demo — accepts headlo-auth OR Clerk, headlo wins on priority.
            </div>
          </a>
        </section>
      </main>
